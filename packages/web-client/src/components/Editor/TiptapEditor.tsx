...
export default function TiptapEditor({ content, onChange, documentId, socket }: TiptapEditorProps) {
    ...
    useEffect(() => {
        ...
        function handleEdit({ content: remoteContent }: { content: string; userId: string }) {
            if (!editor) return;
        ...
        return () => { socket.off('edit', handleEdit); };
    }, [socket, editor]);

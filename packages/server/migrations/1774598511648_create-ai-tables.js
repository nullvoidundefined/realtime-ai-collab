...
export const up = (pgm) => {
    pgm.createTable("ai_suggestions", {
        ...
        prompt_type: { type: "varchar(20)", notNull: true, check: "prompt_type IN ('continue','improve','summarize','expand')" },
        suggestion_text: { type: "text", notNull: true, default: "''" },
        status: { type: "varchar(20)", notNull: true, default: "'streaming'", check: "status IN ('streaming','pending','accepted','rejected','edited')" },
